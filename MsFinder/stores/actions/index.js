...
export const REQUEST_REMLOC = 'REQUEST_REMLOC'
export const SUCCESS_REMLOC = 'SUCCESS_REMLOC'
...
export const successSignOut = createAction(SUCCESS_SIGNOUT);
...
export const requestRemLoc = createAction(REQUEST_REMLOC);
export const successRemLoc = createAction(SUCCESS_REMLOC);
